...
public class HazelcastServer {
  ...
  // members
  static final Logger log = LoggerFactory.getLogger(HazelcastServer.class);
  private final String instanceName;
  private final MapStore store;
  private final String storeType;

  // public API
  public HazelcastServer(final MapStore store, final String storeType) {
    this.store = store;
    this.storeType = storeType;
    log.info("Creating Hazelcast CEP instance(server)..");
