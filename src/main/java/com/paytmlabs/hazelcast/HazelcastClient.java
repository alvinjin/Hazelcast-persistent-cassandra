...
public class HazelcastClient {
  ...
  // members
  static final Logger log = LoggerFactory.getLogger(HazelcastClient.class);
  private final IMap<String, User> usersMap;
  private final HazelcastInstance hcInstance;

  public HazelcastClient(final String datastore) {
    log.info("Creating Hazelcast CEP worker(client)..");
    hcInstance = com.hazelcast.client.HazelcastClient.newHazelcastClient(getConfig());
