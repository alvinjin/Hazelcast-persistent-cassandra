...
import com.paytmlabs.hazelcast.HazelcastClient;
import com.paytmlabs.hazelcast.HazelcastServer;
import com.paytmlabs.hazelcast.User;
import com.paytmlabs.hazelcast.mapstore.EntryEntity;
import com.paytmlabs.hazelcast.mapstore.HazelcastMapStore;
...
public class HazelcastCassandraPersistentTest {
  ...
  private HazelcastClient worker;
  private HazelcastServer store;
  ...
  public void setUpClass() throws Exception {
    ...
    store = new HazelcastServer(mapStore, Constants.CASSANDRA_MAP_STORE);

    worker = new HazelcastClient(Constants.CASSANDRA_MAP_STORE);
  }
  ...
  public void test_get_user_data_after_instance_down() {
    ...
    store = new HazelcastServer(mapStore, Constants.CASSANDRA_MAP_STORE);
    new HazelcastServer(mapStore, Constants.CASSANDRA_MAP_STORE);
    new HazelcastServer(mapStore, Constants.CASSANDRA_MAP_STORE);
    worker = new HazelcastClient(Constants.CASSANDRA_MAP_STORE);
