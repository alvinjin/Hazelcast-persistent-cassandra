...
public class Constants {
  ...
  public static final String HBASE_MAP_STORE = "hbase-map-store";
  public static final String CASSANDRA_MAP_STORE = "cassandra-map-store";

  public static final String HBase_KEYSPACE = "example";
  public static final String HBase_TABLE_NAME = "hzentry";
